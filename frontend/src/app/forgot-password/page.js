...
export const metadata = {
  ...
  description: "Request a password reset for a seller or buyer account.",
};
  ...
  return (
    <div className={styles.authWrap}>
      <section className={styles.authCard}>
        ...
        <p>
          Request a password reset link for your seller or buyer account.
          Admin recovery should remain separate from this public flow.
        </p>
        <ul className={styles.bulletList}>
          <li>This recovery page is for sellers and buyers only.</li>
