...
export default function BidderProfilePage() {
  ...
  return (
    <div className={styles.page}>
      <SectionIntro
        title="Buyer profile"
        description="Manage buyer identity, verification, communication preferences, and buying profile settings."
      />
      ...
      <section className={styles.secondaryGrid}>
        <Panel title="Profile summary" description="Core buyer identity and account trust information.">
          <div className={styles.compactList}>
            {[`Name: ${data.name}`, `Role: ${data.role === "Bidder" ? "Buyer" : data.role}`, `Email: ${data.email}`, `Location: ${data.location}`].map((item) => (
              <article key={item} className={styles.compactCard}>
                <div>
                  <strong>{item}</strong>
                  <p>These values are now loaded from your live buyer account.</p>
                </div>
              </article>
            ))}
          </div>
        ...
        <Panel title="Buyer profile modules" description="Identity, communication, and preference systems for your buyer account.">
      ...
      <section className={styles.secondaryGrid}>
        <ProfileEditor
          ...
          description="Maintain buyer identity, profile visibility, and preference-facing account details."
          fields={[
            ...
            { name: "email", label: "Email", type: "email", defaultValue: data.email },
            {
              ...
              label: "Account label",
              defaultValue: String(data.publicRoleLabel || data.role || "").replace(/bidder/gi, "buyer"),
            },
        ...
        <SettingsEditor
          ...
          description="Control buyer-side communication and discovery preferences."
          fields={[
